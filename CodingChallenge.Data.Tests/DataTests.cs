    ...
    public class DataTests
    {
        ...
        public void TestResumenListaVacia()
        {
            Assert.AreEqual("<h1>Lista vacía de formas!</h1>",
                FormaGeometrica.Imprimir(new List<FormaGeometrica>(), Languages.Castellano.GetCode()));
        }
        ...
        public void TestResumenListaConUnCuadrado()
        {
            ...
            var resumen = FormaGeometrica.Imprimir(cuadrados, Languages.Castellano.GetCode());
        ...
        public void TestResumenListaConMasCuadrados()
        {
            ...
            var resumen = FormaGeometrica.Imprimir(cuadrados, Languages.Ingles.GetCode());
        ...
        public void TestResumenListaConMasTipos()
        {
            ...
            var resumen = FormaGeometrica.Imprimir(formas, Languages.Ingles.GetCode());
        ...
        public void TestResumenListaConMasTiposEnCastellano()
        {
            ...
            var resumen = FormaGeometrica.Imprimir(formas, Languages.Castellano.GetCode());
        ...
        public void TestResumenListaConTrapeciosPortugues()
        {
            ...
            var resumen = FormaGeometrica.Imprimir(formas, Languages.Portugues.GetCode());
